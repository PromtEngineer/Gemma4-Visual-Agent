"""
Combined Application: Falcon Perception + Gemma VLM
=====================================================
Launch both Image Analysis and Video Tracking UIs in one Gradio app.
"""

import gradio as gr
from app import (
    detect_and_analyze, quick_count, visual_qa, scene_understanding,
    load_all_models,
)
...
def build_combined_ui():
    with gr.Blocks(title="Falcon + Gemma Vision Pipeline") as demo:
        gr.Markdown(
        ...
        with gr.Tab("Scene Understanding"):
            ...
            scene_btn.click(
                scene_understanding, inputs=[scene_img],
